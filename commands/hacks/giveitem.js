...
import { addAmountToInventory } from '../../helpers/utils.js';
...
export async function execute(interaction) {
    ...
    interaction.reply({ content: `Gave ${interaction.user.id} ${interaction.options.getInteger('amount')} ${item.name}`, flags: MessageFlags.Ephemeral });
}