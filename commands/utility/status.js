...
const offlineinhours = 10; // change this value for time until bot goes offline (in hours from time when commands deployed)
...
const statusEmbed = new EmbedBuilder()
    ...
    .addFields(
        ...
        { name: 'Latest update: v0.74b', value: 'Changes: \n/daily added! What does it give? Well...I suppose we shall find out...\nAdded /stats command to replace deprecated nomcount command...guess what that means?? (you will have more than just nomcount stat now)' },
