...
const statusEmbed = new EmbedBuilder()
    ...
    .addFields(
        ...
        { name: 'Latest update: v0.71b', value: 'Changes: \nQueries Google Gemini API when doing /jeffspeak to get a much more accurate response. No randomisation needed! This may be buggy, please report any issues in the GitHub! (I can\'t tell if this is free I sure hope it is)' },
