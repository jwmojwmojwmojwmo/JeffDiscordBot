...
const offlineinhours = 15; // change this value for time until bot goes offline (in hours from time when commands deployed)
const onlineinhours = 5; // change this value for time until bot comes back online (in hours after bot goes offline)
