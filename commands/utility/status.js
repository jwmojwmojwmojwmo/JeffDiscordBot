...
const timea = now + (10 * 60 * 60); // in form now + ('time in hours' * 60 * 60)
const timeb = timea + (11 * 60 * 60); // in form now + ('time in hours' * 60 * 60)
const statusEmbed = new EmbedBuilder()
    .setTitle('Jeff Discord Bot Status')
    .setThumbnail("https://i.imgur.com/ntg31Zx.jpeg")
    .addFields(
        { name: 'Status: Online - occasional short outages anticipated', value: `Planned to go offline <t:${timea}:R>, planned to come back online <t:${timeb}:R>` },
