...
export async function execute(interaction) {
    ...
    if (!pet) 
        return interaction.reply({ content: `You don't have a pet yet! But rumor has it if you fish up something unknown and use it, you might just find a feisty companion. They may be able to lend a hand with fishing, strengthen your abilities, and have other secret abilities of their own...`, flags: MessageFlags.Ephemeral });
    const subcommand = interaction.options.getSubcommand();
